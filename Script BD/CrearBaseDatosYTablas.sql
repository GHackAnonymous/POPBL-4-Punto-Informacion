...
(
	...
	CONSTRAINT id_anuncios_fk2 FOREIGN KEY(id_anuncios) 
		REFERENCES anuncios(id_anuncios)
);
...
(
	...
	CONSTRAINT id_anuncios_fk3 FOREIGN KEY(id_anuncios)
		REFERENCES anuncios(id_anuncios)
);
...
(
	...
	CONSTRAINT id_anuncios_fk4 FOREIGN KEY(id_anuncios)
		REFERENCES anuncios(id_anuncios)
);
